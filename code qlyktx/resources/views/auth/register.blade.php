...
@section('content')
	<form method="post" class="form_login"
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="mssv" placeholder="Mã số sinh viên gồm 8 chữ số" maxlength="8">
        </div>
        <div class="form-group">
			<input type="text" class="form-control" name="name" placeholder="Họ và tên" maxlength="30">
        </div>
        <div class="form-group">
